...
echo "برای مثال:"
echo "  - برای اجرای اسکریپت هر 5 دقیقه:  */5 * * * *"
echo "  - برای اجرای اسکریپت هر 2 ساعت:   0 */2 * * *"
echo "  - برای اجرای اسکریپت در ساعت 12 ظهر هر روز:  0 12 * * *"
echo "  - برای اجرای اسکریپت در هر روز هفته (شنبه تا پنج‌شنبه) در ساعت 3 بامداد:  0 3 * * 0-4"
echo ""
echo "اگر می‌خواهید اسکریپت خود را هر 5 ساعت اجرا کنید، از زمان‌بندی زیر استفاده کنید:"
echo "  - 0 */5 * * *"
echo "این دستور به این معنی است که اسکریپت در هر 5 ساعت (در دقیقه 0) اجرا می‌شود."
echo ""
