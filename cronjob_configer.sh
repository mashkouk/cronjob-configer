...
# -------------------------------------------
# توضیح زمان‌بندی کرون جاب
# -------------------------------------------
echo ""
echo "-------------------------------------------"
echo "فرمت زمان‌بندی کرون شامل 5 بخش است: دقیقه، ساعت، روز ماه، ماه، روز هفته."
echo "برای مثال:"
echo "  - برای اجرای اسکریپت هر 5 دقیقه:"
echo "    */5 * * * *"
echo "    (اسکریپت در هر 5 دقیقه اجرا می‌شود.)"
echo ""
echo "  - برای اجرای اسکریپت هر 2 ساعت:"
echo "    0 */2 * * *"
echo "    (اسکریپت هر 2 ساعت اجرا می‌شود.)"
echo ""
echo "  - برای اجرای اسکریپت در ساعت 12 ظهر هر روز:"
echo "    0 12 * * *"
echo "    (اسکریپت هر روز در ساعت 12 ظهر اجرا می‌شود.)"
echo ""
echo "  - برای اجرای اسکریپت در هر روز هفته (شنبه تا پنج‌شنبه) در ساعت 3 بامداد:"
echo "    0 3 * * 0-4"
echo "    (اسکریپت در هر روز هفته (شنبه تا پنج‌شنبه) در ساعت 3 بامداد اجرا می‌شود.)"
echo ""
echo "اگر می‌خواهید اسکریپت خود را هر 5 ساعت اجرا کنید:"
echo "  - 0 */5 * * *"
echo "    (اسکریپت در هر 5 ساعت (در دقیقه 0) اجرا می‌شود.)"
echo ""
echo "برای اجرای اسکریپت هر روز در ساعت 8 صبح:"
echo "  - 0 8 * * *"
echo "    (اسکریپت هر روز در ساعت 8 صبح اجرا می‌شود.)"
echo ""
echo "برای اجرای اسکریپت هر شنبه در ساعت 10 شب:"
echo "  - 0 22 * * 6"
echo "    (اسکریپت هر شنبه در ساعت 10 شب اجرا می‌شود.)"
echo ""
echo "برای اجرای اسکریپت در روزهای زوج هر ماه در ساعت 1 بعدازظهر:"
echo "  - 0 13 2-31/2 * *"
echo "    (اسکریپت در روزهای زوج (2، 4، 6، ...) هر ماه در ساعت 1 بعدازظهر اجرا می‌شود.)"
echo ""
